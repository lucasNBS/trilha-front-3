  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="A Conferência Nacional sobre Branqueamento de Corais: Ciência, Conservação e Sustentabilidade é um evento de importância crucial que reunirá especialistas pesquisadores, ambientalistas e formuladores de políticas de todo o mundo para discutir e abordar os desafios enfrentados pelos recifes de coral em meio ao crescente fenômeno do branqueamento."
        />
        <meta charSet="UTF-8" />
